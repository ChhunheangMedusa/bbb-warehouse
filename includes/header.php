...
<div class="sidebar bg-gradient-primary">
    ...
    <div class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'item-control.php' ? 'active' : ''; ?>" href="item-control.php">
                    <i class="bi bi-box-seam me-2"></i><?php echo t('item_management'); ?>
                </a>
            </li>
            <?php if (isAdmin()): ?>
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'location-control.php' ? 'active' : ''; ?>" href="location-control.php">
                    <i class="bi bi-pin-map me-2"></i><?php echo t('location_management'); ?>
                </a>
            </li>
            <?php endif;?>
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'stock-transfer.php' ? 'active' : ''; ?>" href="stock-transfer.php">
            ...
            <?php endif; ?>
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'low-stock-alert.php' ? 'active' : ''; ?>" href="low-stock-alert.php">
