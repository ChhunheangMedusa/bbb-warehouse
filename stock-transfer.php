...
<div class="container-fluid">
                ...
                <div class="col-md-10">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="<?php echo t('search');?>..." value="<?php echo $search_query; ?>">
                     ...
                     <!--   <div class="col-md-3">
                        ...
                        <div class="col-md-2">
            <a href="stock-transfer.php" class="btn btn-danger w-100">Reset</a>
        </div>
                    </form>
                </div>
    ...
    <a href="#" 
       ...
       data-item-name="<?php echo htmlspecialchars($transfer['item_name']); ?>"
       data-quantity="<?php echo $transfer['quantity']; ?>"
       data-from-location="<?php echo htmlspecialchars($transfer['from_location']); ?>"
       data-to-location="<?php echo htmlspecialchars($transfer['to_location']); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // Set the delete URL
            const deleteUrl = `stock-transfer.php?delete=${this.getAttribute('data-id')}`;
